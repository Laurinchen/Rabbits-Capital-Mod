...
---@generic T
---@generic U
---@param the_table table<T, U>
---@return table<integer, T>
function GetKeys(the_table)
    ---@type table
    local keys = {};
...
---@generic T
---@param the_table table<any, T>
---@return table<integer, T>
function GetValues(the_table)
    ---@type table
    local values = {};
...
---@param TStanding table<TerritoryID, TerritoryStanding>
function IsTerritoryOwnedByPlayer(PlayerID, TerritoryID, TStanding)
    for territoryid, standing in pairs(TStanding) do
        if territoryid == TerritoryID then
            return PlayerID == standing.OwnerPlayerID;
        end
    end
end
